...
function create_game()//inicializar jogo
{
	level=1
	can_input=false
	delay=0
	...
	output_signals()//jogar start
}

function animate_pressed_button(name)//animação pressionar
{
...
function animate_sequence_button(id)//botoes
{
	$(id).addClass("active")
	setTimeout(function(){
...
$(".ibutton").click(function()//clicar botao
{
	if (can_input)
	{
...
function validate_input(buttonid)
{
